...
data class WorldState(
    ...
    /**
     * Phase 20 Target 2 & 3: Ultra-compact, token-efficient semantic representation (< 150 tokens)
     * using relevant node ranking and compressed formatting.
     */
    fun toOptimizedSemanticIndex(
        goal: String? = null,
        subgoal: String? = null,
        maxNodes: Int = 18
    ): String {
        return com.assistive.headmouse.agent.jarvis.autonomous.perf.AccessibilityTreeCompressor.compress(
            worldState = this,
            goal = goal,
            subgoal = subgoal,
            maxNodes = maxNodes
