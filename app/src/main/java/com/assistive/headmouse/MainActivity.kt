...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupSettingsTab() {
        ...
        // J.A.R.V.I.S. Mission Trace Debugger (Phase 19)
        binding.btnOpenJarvisDebugger.setOnClickListener {
            com.assistive.headmouse.ui.debugger.JarvisDebuggerDialog(this).show()
        }
    ...
    private fun setupJarvisTab() {
        ...
        // Phase 19: J.A.R.V.I.S. Mission Trace Debugger Dialog
        binding.btnJarvisTabDebugger.setOnClickListener {
            com.assistive.headmouse.ui.debugger.JarvisDebuggerDialog(this).show()
        }
